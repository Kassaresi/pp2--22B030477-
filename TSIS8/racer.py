...
background = pygame.image.load("/Users/kassi/TSIS8/data_for_racer/background_racer.jpg")
...
class Enemy(pygame.sprite.Sprite):
    #Генерация вражеской машины, которая появляется на верху карты, также имеет картинку 
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("/Users/kassi/TSIS8/data_for_racer/enemy_car.png")
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("/Users/kassi/TSIS8/data_for_racer/player_car.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/kassi/TSIS8/data_for_racer/coin_for_racer.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    monitor.blit(coins_view,(535,10))
    ...
    if pygame.sprite.spritecollideany(p1, enemies):
        # При столкновении с вражеской машиной, происходит музыкальное сопровождение
          pygame.mixer.Sound('/Users/kassi/TSIS8/data_for_racer/crash.wav').play()
          time.sleep(0.5)
